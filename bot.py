...
# ID регіону згідно з API alerts.in.ua (наприклад, "31" - м. Київ, "10" - Київська область)
REGION_ID = "31"
REGION_NAME = "м. Київ"
...
"last_alert_end": None,
"subscribers": set(),  # ID чатів для розсилки (у реальному проєкті краще використовувати БД)
            ...
            try:
                async with session.get(url, headers=headers) as response:
                    if response.status == 200:
                        ...
                        # Якщо масив 'alerts' не порожній — тривога активна
...
for chat_id in list(state["subscribers"]):
try:
# Відкріплюємо попереднє повідомлення про тривогу
...
"""Відповідає на слово 'карта' та додає кнопку WebApp/посилання."""
